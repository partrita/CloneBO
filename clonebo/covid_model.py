...
class MultiABOnlyCoronavirusModel(pl.LightningModule):
    ...
    def load_from_checkpoint(cls, checkpoint_path, *args, **kwargs):
        ...
        # Transpose specific tensors
        new_state_dict['encoder.rnn_ab.rnn.rnn_lst.0.weight'] = new_state_dict['encoder.rnn_ab.rnn.rnn_lst.0.weight'].t()
        new_state_dict['encoder.rnn_ab.rnn.rnn_lst.1.weight'] = new_state_dict['encoder.rnn_ab.rnn.rnn_lst.1.weight'].t()
...
class CovidNeutralizationModel():
    ...
    def __init__(self):
        MODEL_PATH = "oracle_data/neut_model.ckpt"
        MODEL_ARGS = {
            "hidden_dim": 256,
            "n_layers": 2,
            "use_srupp": False
